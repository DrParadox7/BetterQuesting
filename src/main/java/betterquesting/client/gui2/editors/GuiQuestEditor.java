...
public class GuiQuestEditor extends GuiScreenCanvas implements IPEventListener, IVolatileScreen, INeedsRefresh {
    ...
    public void refreshGui() {
        ...
        if (quest == null) {
            ...
            btnShowParent.setText(QuestTranslation.translate("betterquesting.btn.showparentconnection") + ": "
                    + quest.getProperty(NativeProps.SHOW_PARENT_CONNECTION));
        }
    }
    ...
    public void initPanel() {
        ...
        PanelButton btnAdv = new PanelButton(
                new GuiTransform(GuiAlign.MID_CENTER, -100, 64, 100, 16, 0),
                4,
                QuestTranslation.translate("betterquesting.btn.advanced"));
        cvBackground.addPanel(btnAdv);

        btnShowParent = new PanelButton(
                new GuiTransform(GuiAlign.MID_CENTER, 0, 64, 100, 16, 0),
                9,
                QuestTranslation.translate("betterquesting.btn.showparentconnection") + ": "
                        + quest.getProperty(NativeProps.SHOW_PARENT_CONNECTION));
        cvBackground.addPanel(btnShowParent);

        PanelButton btnVisReq = new PanelButton(
                new GuiTransform(GuiAlign.MID_CENTER, -100, 80, 100, 16, 0),
                10,
                QuestTranslation.translate("betterquesting.btn.vis_requirements"));
    ...
    private void onButtonPress(PEventButton event) {
        ...
        switch (btn.getButtonID()) {
            ...
            case 9: {
                ...
                ((PanelButton) btn)
                        .setText(QuestTranslation.translate("betterquesting.btn.showparentconnection") + ": "
                                + !currentState);
                SendChanges();
                break;
            }
            ...
            case 10: {
                mc.displayGuiScreen(
                        new betterquesting.client.gui2.editors.GuiVisibilityPrerequisiteEditor(this, quest));
                break;
            }
        }
    }
