...
public enum PresetColor {
    ...
    public static void registerColors(IThemeRegistry reg) {
        ...
        reg.setDefaultColor(
                TEXT_HIGHLIGHT.key, new GuiColorStatic(0, 0, 255, 255)); // Selection Highlight (Blue Invert)
        reg.setDefaultColor(
                TEXT_WATERMARK.key, new GuiColorStatic(128, 128, 128, 255)); // Text Field Watermark (Grey Text)
        ...
        reg.setDefaultColor(
                UPDATE_NOTICE.key, new GuiColorPulse(quickMix(255, 255, 0, 255), quickMix(128, 128, 0, 255), 1F, 0F));
        ...
        reg.setDefaultColor(QUEST_LINE_VIS.key, new GuiColorStatic(0, 0, 255, 255));

        reg.setDefaultColor(QUEST_ICON_LOCKED.key, new GuiColorStatic(128, 128, 128, 255));
        reg.setDefaultColor(
                QUEST_ICON_UNLOCKED.key, new GuiColorPulse(quickMix(192, 0, 0, 255), quickMix(96, 0, 0, 255), 1F, 0F));
        reg.setDefaultColor(
                QUEST_ICON_PENDING.key,
